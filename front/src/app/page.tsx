        ...
        <>
            <div className="glass-panel p-8">
                ...
                <p className="text-gray-400 max-w-2xl">
                    Navega en el menú lateral para adquirir nuevos tickets o
                    consultar tu inventario disponible. El estado de compra se
                    actualiza instántaneamente gracias a la integración global.
                </p>
            </div>
